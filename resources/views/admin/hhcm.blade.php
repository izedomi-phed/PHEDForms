                   ...
                   <div class="col-12 col-md-12 mt-25">
                        <ul class="nav nav-vertical">
                            ...
                            <a class="nav-link active" data-toggle="tab" href="#new">
                                ...
                                <!-- <p class="text-center text-dark">PHED EMPLOYEES APPRAISALS</p> -->
                            </a>
                            </li>           
                        </ul>
                    </div>
                            ...
                            <tbody>
                                @foreach($employees as $employee)
                                    <tr class="text-center">
                                        ...
                                        <td> 
                                              @if($employee->reviewer_rating != null)  
                                                <button type="button" class="btn btn-sm btn-round btn-secondary" data-toggle="modal" data-target="#exampleModal" data-id="{{$employee->staff_id}}">
                                                Normalize
                                                </button>
                                              @endif
            ...
            <div class="modal-content">
                ...
                <form method="post" action="normalize">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="admin_access" value="hhcm"/>
